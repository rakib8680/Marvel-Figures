...
const Home = () => {
    ...
    return (
        <div>
            {/* banner  */}
            <div className='background md:mb-0'>
                <div className='container mx-auto'>
                    ...
                    <div className=' text-center md:mt-[480px] mt-[300px] backdrop-blur-md py-6 px-4 w-fit mx-auto bg-white  rounded-md  bg-opacity-5'>
